...
(function($) {
  ...
  /*----------------------------------------------------*/
   ...
   if($("html").hasClass('cssanimations')) {
      ...
      {
        $( '<div class="imagelightbox-loading"><div></div></div>' ).appendTo( 'body' );
      },
      ...
      {
        $( '<a href="#" class="imagelightbox-close" title="close"><i class="fa fa fa-times"></i></a>' ).appendTo( 'body' ).on( 'click touchend', function(){ $( this ).remove(); instance.quitImageLightbox(); return false; });
      },
    ...
    /*----------------------------------------------------*/
      $("#work").find(".item-wrap a").attr("rel","prettyPhoto[pp_gal]");
